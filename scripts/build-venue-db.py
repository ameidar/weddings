...
CITY_AREA = {
 ...
 'נס ציונה':'שפלה','יבנה':'שפלה','כנות':'שפלה','קריית עקרון':'שפלה','רחובות':'שפלה','מודיעין-מכבים-רעות':'שפלה','מודיעין':'שפלה','כפר אוריה':'שפלה','בית עובד':'שפלה','צומת ראם':'שפלה','קיבוץ חפץ חיים':'שפלה','שדה יואב':'שפלה','עמק האלה':'שפלה','נצר סרני':'שפלה','לטרון':'שפלה',
 'ירושלים':'ירושלים','נווה אילן':'ירושלים','בית שמש':'ירושלים','עין חמד':'ירושלים',
 'אשדוד':'דרום','אשקלון':'דרום','באר שבע':'דרום','נתיבות':'דרום','אופקים':'דרום','קריית מלאכי':'דרום','בני דרום':'דרום','ירוחם':'דרום'
}
